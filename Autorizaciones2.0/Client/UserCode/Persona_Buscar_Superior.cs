...
namespace LightSwitchApplication
{
    public partial class Persona_Buscar_Superior
    {
        ...
        {
            if (this.Persona.SelectedItem.Es_Gerente == true){ this.ShowMessageBox("Este empleado posee un cargo de gerente en: "+ this.Persona.SelectedItem.Superior_Gerente.First().Division_GerenciaItem.Nombre);}
            else if (this.Persona.SelectedItem.Es_JefeDirecto == true) { this.ShowMessageBox("Este empleado posee un cargo de jefe de área en: " + this.Persona.SelectedItem.Superior_JefeDirecto.First().Division_AreaItem.Nombre); }
            else if (this.Persona.SelectedItem.Es_SubGerente == true) { this.ShowMessageBox("Este empleado posee un cargo de subgerente en: " + this.Persona.SelectedItem.Superior_SubGerente.First().Division_SubGerenciaItem.Nombre); }
            else
            {
